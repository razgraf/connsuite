...
function ModalArticleLeave({ className, onSuccess: onSuccessCallback }) {
  const id = modals.articleLeave;
...
ModalArticleLeave.propTypes = {
  className: PropTypes.string,
  onSuccess: PropTypes.func,
};

ModalArticleLeave.defaultProps = {
  className: null,
  onSuccess: () => {},
};

export default ModalArticleLeave;

...
**NOTE:** If you want to use the defaultImage navigation styles, you will also need to include `owl.theme.defaultImage.css`.
...
This package comes with [Grunt](http://gruntjs.com/) and [Bower](http://bower.io/). The following tasks are available:
  ...
  * `defaultImage` compiles the CSS and JS into `/dist` and builds the doc.

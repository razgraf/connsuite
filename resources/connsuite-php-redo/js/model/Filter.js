...
class Filter extends ClassHelper{
...
class FilterItem extends ClassHelper{
    ...
    constructor(object){
        super();
        this.ID = this.getValue(object, "ID");
        this.type = this.getValue(object, "type");
        this.name =  this.getValue(object, "name");
        this.initial = this.getArray(object, "initial") ? this.getArray(object, "initial") : "";
        this.chosen = this.initial;
        this.options = [];

        let temp = this.getArray(object,"options");
...
FilterItem.prototype.isCustomized = function(){
...
FilterItem.prototype.getOptionByValue = function(value){
...
class FilterOption extends ClassHelper{
    get source() {
        return this._source;
    }
    ...
    this.name = this.getValue(object, "name");
    this.value = this.getValue(object, "value") ? this.getValue(object, "value") : "";

    this.maxLength = this.getValue(object, "maxLength");
    this.placeholder = this.getValue(object, "placeholder");

    this.type = this.getValue(object, "type") ? parseInt(this.getValue(object, "type")) : null;
    this.source = this.getArray(object,"source");

...
import { TextField, FileField, URLField, AreaField, TagField, EditorJSField } from "../index";
...
class Form extends Component {
  ...
  doUpdateFieldValue = (fieldID, value) => {
    if (Helper.isEmpty(fieldID)) {
      console.error("Empty fieldID in form value update.");
      return;
    }
  ...
  doUpdateFieldWarnValue = (fieldID, warn = true) => {
    console.log(fieldID);
    if (Helper.isEmpty(fieldID)) {
      console.error("Empty fieldID in form warn update.");
      return;
    }
  ...
  doDefineFieldScope = (fieldID, scope) => {
    if (Helper.isEmpty(fieldID)) {
      console.error("Empty fieldID in form scope update.");
      return;
    }
        ...
        <div className={styles.container}>
          {this.state.fields.map((element, index) => {
            ...
            switch (element.type) {
              ...
              case "File":
                return <FileField {...configuration} />;
              case "URL":
                return <URLField {...configuration} />;
              case "Area":
                return <AreaField {...configuration} />;
              case "Tag":
                return <TagField {...configuration} />;
              case "EditorJSField":
                return <EditorJSField {...configuration} />;
              default:

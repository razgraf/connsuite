                                    ...
                                    <div className={styles.content}>
                                        <div className={styles.step} data-step={0}
                                            ...
                                            <section className={styles.default}
                                                     data-active={this.state.activeSection === 0} onClick={() => {
                                                this.pickSection(0)
                                            }}>
                                                <div className={styles.title}><p><span>a.</span> Choose the network you
                                                    want to add</p></div>
                                                <div data-active={this.state.shouldWarnDefaultStep0}
                                                     className={styles.warn}>
                                                    <div className={styles.content}><p>You must choose a network in
                                                        order to move to the next step</p></div>
                                                </div>
                                                <div className={styles.content}>
                                            ...
                                            <section className={styles.custom}
                                                     data-active={this.state.activeSection === 1} onClick={() => {
                                                this.pickSection(1)
                                            }}>
                                                <div className={styles.title}><p><span>b.</span> Or create a custom
                                                    network</p></div>
                                                <div className={styles.content}>
                                                    <Form
                                        ...
                                        <div className={styles.step} data-step={1}
                                             data-active={this.state.activeStep === 1}>
                                            {
                                                this.state.activeSection === 0
                                                    ? <section className={styles.default}>
                                                        <div className={styles.title}>
                                                            <p>{`What is your username on ${active.title}?`}</p></div>
                                                        <div className={styles.subtitle}><p>You know how every social
                                                            network had to ask you for a username <Emoji symbol={'🤔'}/> ?
                                                        </p></div>
                                                        <div className={styles.content}>
                                                            <Form
                                            ...
                                            }
                                            {
                                                this.state.activeSection === 1
                                                    ? <section className={styles.custom}>
                                                        <div className={styles.title}><p>Tell us more about this
                                                            network/website. How can we reach it?</p></div>
                                                        <div className={styles.subtitle}><p>Aside from the url, you can
                                                            optionally add a custom username. If empty, it will default to
                                                            your First Name.</p></div>
                                                        <div className={styles.content}>
                                        ...
                                        <div className={styles.step} data-step={2}
                                             data-active={this.state.activeStep === 2}>

                                            <section>
                                                <div className={styles.title}><p>You're almost there! </p><Emoji
                                                    symbol={'👌'}/></div>
                                                <div className={styles.subtitle}><p>Once you go live, you'll have one
                                                    more network added to your online business card! To confirm
                                                    everything, click on the 'Go Live' button.</p></div>
                                                <div className={styles.content}>

                                                    <div className={styles.summary}>
                                                        <div className={styles.group}>
                                                            <FieldShowcase design={FieldShowcase.GRAY_BACKGROUND}
                                                                           label={{value: "Network"}}
                                                                           value={active.title}/>
                                                            <FieldShowcase design={FieldShowcase.GRAY_BACKGROUND}
                                                            ...
                                                            {this.state.activeSection === 1 ?
                                                                <FieldShowcase columnSpan={2}
                                                                               design={FieldShowcase.GRAY_BACKGROUND}
                                                                               label={{value: "Link/URL"}}
                                                                               value={active.URL}/> : null}
                                                        </div>
                                                    </div>
                                                    <div className={styles.action}>
                                                        ...
                                                        <Button custom={{style: styles, className: "buttonLive"}}
                                                                title={"Go Live"}
                                                                icon={<Icon icon round className={styles.icon}
                                                                            source={"flash_on"} alt={"Go Live"}/>}
                                            ...
                                            <section>
                                                <div className={styles.subtitle}><p>* P.S. Optionally, you could add a
                                                    description to this account.</p></div>
                                                <div className={styles.content}>
                                                    <Form
                                                        columns={1}
                                                        fields={[
                                ...
                                <div className={styles.divider}/>
                                {
                                    this.state.activeStep <= 2
                                        ...
                                        <Button custom={{style: styles, className: "buttonRight"}}
                                                ...
                                                icon={this.state.activeStep === this.state.steps[this.state.steps.length - 1].id ?
                                                    <Icon icon round className={styles.icon} source={"flash_on"}
                                                          alt={"Step 2"}/> : null}
                                                type={ButtonType.DEFAULT}

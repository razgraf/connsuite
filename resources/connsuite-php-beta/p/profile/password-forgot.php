...
if($user) header("Location: password-change.php");

if(!isset($_GET['e']) || count($_GET['e']) == 0) header("Location: ".ROOT);
if(!isset($_GET['t']) || count($_GET['t']) == 0) header("Location: ".ROOT);
if(!isset($_GET['i']) || count($_GET['i']) == 0) header("Location: ".ROOT);

$email = secureString($_GET['e']);
$token = secureString($_GET['t']);
$insertID = secureString($_GET['i']);
...
<head>
    ...
    <meta charset="UTF-8">
    <title>Forgot Password | ConnSuite</title>
    ...
    <link rel="stylesheet" href="../../css/p/profile/password-forgot.css">
...
<div class="background" style="display: flex">
    <div style="width: 100%;">
        ...
        <script>
            $(function() {
                <?php
                echo 'loadSecondaryToolbar(' . $depthToRoot[PAGE_PASSWORD_FORGOT_KEY] . ',"Stranger","' . "Replace Password" . '","../../image/connsuite_icon_inverted_rounded.png",null);';
                ?>

            });
            
            var depthToRoot = <?php echo $depthToRoot[PAGE_PASSWORD_FORGOT_KEY] ?> ;

            var doTokenCheck = "<?php echo ROOT.$pathFromRoot[CORE_DO_PASSWORD_FORGOT_CHECK] ?>";
            var doPasswordChange = "<?php echo ROOT.$pathFromRoot[CORE_DO_PASSWORD_FORGOT_CHANGE] ?>";


            let token = "<?php echo $token ?>";
            let email = "<?php echo $email ?>";
            let insertID = "<?php echo $insertID ?>";
            ...
            <div class="customContainerPadding" style="background: #ffffff;min-height: 300px;">
                <div id="mainContentContainer">
                    ...
                    <div class="container-fluid row" style="margin: 0; padding: 0;">
                        <div class="col-sm-4 col-xs-12" id="illustrationCol" style="margin-right: 0; margin-left: 0;" >
                        ...
                        <div class="col-sm-8 col-xs-12" style="margin-right: 0; margin-left: 0; padding: 0;">
    ...
    <div class="modal-dialog" role="document" >
        <div class="modal-content" >
            <div class="modal-header modal-headerComplementary">
                ...
                <h4 class="modal-title" id="myModalLabel">Is this the password you want to use?</h4>
            </div>
...
<script src="../../js/p/profile/password-forgot.js"></script>
